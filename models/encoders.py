...
class SentenceEncoder(nn.Module):
    def __init__(self, args, vocab_size, weight_matrix = None):
        self.word_embedder = WordEmbedder(vocab_size, args.word_dim, weight_matrix, trainable = args.emb_train)
        self.gcn_layers = GCNNet(args.word_dim, args.out_word_dim, hidden_dims=args.word_gcn_hidden, dropout_rate=args.word_gcn_dropout)
