...
encoder = SentenceEncoder(
    ...
    word_dim=WORD_DIM,
    out_word_dim=WORD_GCN_OUT,
    word_gcn_hidden=WORD_GCN_HIDDEN,
    weight_matrix=emb_weights,
    word_gcn_dropout=WORD_GCN_DROPOUT,
)

decoder = FinalDecoderRNN(
    word_dim=WORD_DIM, vocab_size=vocab.word_count, dropout_rate=DECODER_DROPOUT
)
